...
void header(){
    printf("\t\t\t|==================================================================|\n");
    printf("\t\t\t|------------------------IDENTITAS PEMBUAT-------------------------|\n");
    printf("\t\t\t|==================================================================|\n");
    printf("\t\t\t|  Nama Lengkap:                          |  NIM:                  |\n");
...
void rek_RT11(){
    ...
    fprintf(file,"\t\t\t| Golongan Meter | D1 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
    fprintf(file,"\t\t\t| Administrasi   | %.2f\n", ADMIN);
    fprintf(file,"\t\t\t_________________|__________________________________________________\n\n");
...
void rek_RT12(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D1 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT13(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D1 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT14(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D1 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT21(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D2 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT22(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D2 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT23(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D2 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT24(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D2 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT31(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D3 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT32(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D3 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT33(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D3 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT34(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D3 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT41(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D4 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT42(){
    ...
    float besar_pemakaian = pemakaian_saat_ini - pemakaian_bulan_lalu;
    float biaya_air;
    if(besar_pemakaian>0 && besar_pemakaian<=10) biaya_air=3740*10;//10 = minimum pemakaian
    else if(besar_pemakaian>10 && besar_pemakaian<=20) biaya_air=4020*besar_pemakaian;
    else if(besar_pemakaian>20) biaya_air=6300*besar_pemakaian;
    else{
        system("clear");
        printf("\t\t\t====================================================================\n");
        printf("\t\t\t|                        INPUT SALAH                               |\n");
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D4 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT43(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D4 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT44(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D4 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT51(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D5 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT52(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D5 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT53(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D5 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_RT54(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Rumah Tangga\n");
    fprintf(file,"\t\t\t| Golongan Meter | D5 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_r);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
//kategori usaha >> lebar jalan 1. Lebar jalan 0 meter - 6,99 meter
void tl_U1() 
{
    system("clear");
    printf("\t\t\t====================================================================\n");
...
//kategori usaha >> lebar jalan 2. Lebar jalan 7 meter - 10 meter
void tl_U2() 
{
    system("clear");
    printf("\t\t\t====================================================================\n");
...
//kategori usaha >> lebar jalan 3. Lebar jalan lebih dari 10 meter
void tl_U3() 
{
    system("clear");
    printf("\t\t\t====================================================================\n");
...
void rek_U11(){
    ...
    fprintf(file,"\t\t\t|                |                                                  \n");
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E1 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U12(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E1 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U13(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E1 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U14(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E1 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U21(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E2 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U22(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E2 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U23(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E2 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U24(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E2 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U31(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E3 - 1\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U32(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E3 - 2\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U33(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E3 - 3\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
...
void rek_U34(){
    ...
    fprintf(file,"\t\t\t| Username       | %s\n", username);                  
    fprintf(file,"\t\t\t| Kelompok       | Usaha\n");
    fprintf(file,"\t\t\t| Golongan Meter | E3 - 4\n");
    fprintf(file,"\t\t\t| Pemakaian      | %.2f M^3\n", besar_pemakaian);
    fprintf(file,"\t\t\t| Biaya Pakai    | %.2f\n", biaya_air);
    fprintf(file,"\t\t\t| BPM            | %.2f\n", bpm_u);
    fprintf(file,"\t\t\t| Denda          | %.2f\n", biaya_denda);
